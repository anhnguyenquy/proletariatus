...
export const EducationField = (): JSX.Element => {
  ...
  return (
    <Field title='Education' sx={style}>
      <IconButton color='primary' component='span' className='add-education-button'>
        <FaPlus className='add-education-button-icon' />
      </IconButton>
      <div className='items'>
        {
            ...
            return (
              <>
                <div className='item'>
                  ...
                  <IconButton color='primary' component='span' className='edit-education-button'>
                    <Pen className='edit-education-button-icon' />
                  </IconButton>
                </div>
                {
